...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, "templates")],  # [os.path.join(BASE_DIR, "templates")] optional, only because we needed to show a template
...
TIME_ZONE = 'UTC' #'America/Los_Angeles' #'US' #'UTC'
